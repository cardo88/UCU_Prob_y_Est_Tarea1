...
def monty_hall_simulacion(cambiar_puerta=True):
    ...
    print("Puerta elegida por el participante:", puerta_elegida_por_jugador)
    print("Puerta donde está el auto:", puerta_con_auto)
    print("Puerta abierta por el presentador:", puerta_abierta_por_presentador)
    if cambiar_puerta:
        print("El participante cambió de puerta y eligió la puerta:", puerta_elegida_por_jugador)
